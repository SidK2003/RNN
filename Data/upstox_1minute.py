...
# Minute data available from Jan 2022
...
output_dir = "historical_data_1min"
...
def fetch_historical_data(asset_name, instrument_key):
    ...
    while current_start < end_date:
        ...
        # IMPORTANT:
        # Upstox minute APIs require small chunks.
        # 28-day chunks are safe.
    ...
    filename = f"{asset_name.lower()}_1min.csv"
